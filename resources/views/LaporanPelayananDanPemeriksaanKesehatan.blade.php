...
@section('body')
                            ...
                            <tr>
                                ...
                                @if (Auth::user()->role_id == 4)
                                    <td>
                                        @if (!$data->validator())
                                            <form method="POST"
                                                action="/smk3/laporan-pelayanan-dan-pemeriksaan-kesehatan/validate">@csrf
                                        @endif
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/smk3/laporan-pelayanan-dan-pemeriksaan-kesehatan/edit" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_pelaporanEdit"
    ...
    <script>
        ...
        function changeModal(id) {
            ...
            xhttp.onload = function() {
                ...
                if (res.jenis_laporan == "Laporan Pelayanan") document.getElementById('jenis_laporanEdit').options[0]
