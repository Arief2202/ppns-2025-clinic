                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumentasi_distribusi }}','_blank')">Lihat
                                        Dokumen</button></td>
                ...
                <form method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="dokumentasi_distribusi"
                                name="dokumentasi_distribusi" required>
                        </div>
                    </div>
                ...
                <form action="/rekam-medis/distribusi-rekam-medis/edit" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_distribusiEdit"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="dokumentasi_distribusiEdit"
                                name="dokumentasi_distribusi">
                        </div>
                    </div>
