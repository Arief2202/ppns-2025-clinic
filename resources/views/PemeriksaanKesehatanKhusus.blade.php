...
@section('body')
    ...
    <div class="row mt-2 mb-3">
        <div class="col-6">
            <div class="col">
                <h5 class="card-title">Pemeriksaan Kesehatan Khusus</h5>
            </div>
        </div>
                    ...
                    <table id="myTable">
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->bagian }}</td>
                                <td>{{ $data->alasan_pemeriksaan }}</td>
                                <td>{{ date('d M Y', strtotime($data->tanggal_pemeriksaan)) }}</td>
                                <td>{{ $data->hasil }}</td>
                                <td>{{ $data->catatan }}</td>
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumen_hasil_pemeriksaan }}','_blank')">Lihat
                                        Dokumen</button></td>
            ...
            <div class="modal-content">
                <form method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="alasan_pemeriksaan" class="form-label">Alasan Pemeriksaan</label>
                            <input type="text" class="form-control" id="alasan_pemeriksaan" name="alasan_pemeriksaan"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="dokumen_hasil_pemeriksaan"
                                name="dokumen_hasil_pemeriksaan" required>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-khusus/edit" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="alasan_pemeriksaanEdit" class="form-label">Alasan Pemeriksaan</label>
                            <input type="text" class="form-control" id="alasan_pemeriksaanEdit"
                                name="alasan_pemeriksaan">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_pemeriksaanEdit" class="form-label">Tanggal Pemeriksaan</label>
                            <input type="date" class="form-control" id="tanggal_pemeriksaanEdit"
                        ...
                        <div class="mb-3">
                            <label for="dokumen_hasil_pemeriksaanEdit" class="form-label">Dokumen Hasil
                                Pemeriksaan</label>
                            <input type="file" class="form-control" id="dokumen_hasil_pemeriksaanEdit"
                                name="dokumen_hasil_pemeriksaan">
                        </div>
                    </div>
    ...
    <script>
        ...
        function changeModal(id) {
            ...
            xhttp.onload = function() {
                ...
                document.getElementById('alasan_pemeriksaanEdit').value = res.alasan_pemeriksaan;
            ...
            xhttp.open("GET", "/api/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-khusus/get?id=" + id, true);
            xhttp.send();
        }

        function del() {
            $.ajax({
                url: "/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-khusus/delete",
                type: "POST",
                data: {
            ...
            setTimeout(function() {
                window.location.href = "/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-khusus";
            }, 200);
        }
    </script>
@endsection
