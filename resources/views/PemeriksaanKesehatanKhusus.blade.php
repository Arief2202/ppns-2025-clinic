...
@section('body')
    @include('layouts.cardOpen')
                    ...
                    <form method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alasan_pemeriksaan" name="alasan_pemeriksaan" required>
                            </div>
                            <div class="mb-3">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-khusus/edit" method="POST" enctype="multipart/form-data">@csrf
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alasan_pemeriksaanEdit" name="alasan_pemeriksaan">
                            </div>
                            <div class="mb-3">
