...
@section('body')
    ...
    <div class="row mt-2 mb-3">
        <div class="col-6">
            <div class="col">
                <h5 class="card-title">Pemeriksaan Kesehatan Berkala</h5>
            </div>
        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-berkala/edit" method="POST"
...
@section('script')
    <script>
        ...
        function changeModal(id) {
            ...
            xhttp.open("GET", "/api/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-berkala/get?id=" + id, true);
            xhttp.send();
        }

        function del() {
            $.ajax({
                url: "/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-berkala/delete",
                type: "POST",
                data: {
            ...
            setTimeout(function() {
                window.location.href = "/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-berkala";
            }, 200);
        }
    </script>
@endsection
