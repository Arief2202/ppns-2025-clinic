                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumen_pengadaan }}','_blank')">Lihat
                                        Dokumen</button></td>
                                ...
                                @if (Auth::user()->role_id == 1)
                                    <td>
                                        @if (!$data->validatorPengadaan())
                                            <form method="POST" action="/manajemen-farmasi/pengadaan/validate">@csrf
                                        @endif
                                        <input type="hidden" name="id" value="{{ $data->id }}">
                                        <button class="btn btn-success"
                                            {{ $data->validatorPengadaan() ? 'disabled' : 'type="submit"' }}>Validasi</button>
                                        @if (!$data->validatorPengadaan())
                                            </form>
                                        @endif
                                    </td>
                                ...
                                <td><a class="btn btn-primary"
                                        href="/manajemen-farmasi/pengadaan/detail?id={{ $data->id }}">Detail</button>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                ...
                <div class="modal-content">
                    <form method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="status" value="Menunggu Validasi Dokter">
                            <div class="mb-3">
                                <label for="nomor_pengadaan" class="form-label">Nomor Pengadaan</label>
                                <input type="text" class="form-control" id="nomor_pengadaan" name="nomor_pengadaan"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="dokumen_pengadaan" name="dokumen_pengadaan"
                                    required>
                            </div>
                            <div class="mb-3">
                    ...
                    <form action="/manajemen-farmasi/pengadaan/edit" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nomor_pengadaanEdit"
                                    name="nomor_pengadaan" required>
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_pengadaanEdit" class="form-label">Tanggal Pengadaan</label>
                                <input type="date" class="form-control" id="tanggal_pengadaanEdit"
                                    name="tanggal_pengadaan">
                            </div>
                            <div class="mb-3">
                                <label for="dokumen_pengadaanEdit" class="form-label">Dokumen Pengadaan</label>
                                <input type="file" class="form-control" id="dokumen_pengadaanEdit"
