...
@section('body')
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumen_surat }}','_blank')">Lihat Dokumen</button>
                                </td>
                                ...
                                @if (Auth::user()->role_id == 4)
                                    <td>
                                        @if (!$data->validator())
                                            <form method="POST"
                                                action="/sarana-prasarana/izin-pendirian-dan-operasional-klinik/validate">
                                                @csrf
                                        @endif
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/sarana-prasarana/izin-pendirian-dan-operasional-klinik/edit" method="POST"
