...
@section('body')
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumentasi }}','_blank')">Lihat
                                        Dokumentasi</button></td>
                ...
                <form method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="deskripsi_program" name="deskripsi_program"
                                required>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/kesehatan-mental/program-promotif-kesehatan-mental/edit" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="deskripsi_programEdit"
                                name="deskripsi_program">
                        </div>
                        <div class="mb-3">
                            <label for="tanggal_pelaksanaanEdit" class="form-label">Tanggal Pelaksanaan</label>
                            <input type="date" class="form-control" id="tanggal_pelaksanaanEdit"
