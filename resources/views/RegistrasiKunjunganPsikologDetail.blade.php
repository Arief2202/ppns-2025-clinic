...
@section('body')
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-secondary"
                                        onclick="window.open('{{ $item->dokumen_rujukan }}','_blank')">Lihat
                                        Dokumen</button></td>
    ...
    @if (Auth::user()->role_id == 5)
        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/kesehatan-mental/registrasi-kunjungan-psikolog/detail/create" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="">
                                <label for="status_intervensi_lanjutan" class="form-label">Status Intervensi
                                    Lanjutan</label>
                            </div>
                            <div class="mb-2">
                                <select class="selectpicker" data-live-search="true" id="status_intervensi_lanjutan"
                                    name="status_intervensi_lanjutan">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="date" class="form-control" id="tanggal_rujukan" name="tanggal_rujukan"
                                    required>
                            </div>
                            <div class="mb-2">
                                <label for="dokumen_rujukan" class="form-label">Dokumen Rujukan</label>
                                <input type="file" class="form-control" id="dokumen_rujukan" name="dokumen_rujukan"
                                    required>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/kesehatan-mental/registrasi-kunjungan-psikolog/edit" method="POST"
                        enctype="multipart/form-data">@csrf
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-2">
                                <select class="selectpicker" data-live-search="true" id="pasien_idEdit"
                                    name="pasien_id">
                            ...
                            <div class="mb-2">
                                <select class="selectpicker" data-live-search="true" id="pemeriksa_idEdit"
                                    name="pemeriksa_id">
                                    <option value="">Pilih Pemeriksa</option>
                                    @foreach ($pemeriksas as $pemeriksa)
                                        <option value="{{ $pemeriksa->id }}">[{{ $pemeriksa->nip }}]
                                            {{ $pemeriksa->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_kunjunganEdit" class="form-label">Tanggal Kunjungan</label>
                                <input type="date" class="form-control" id="tanggal_kunjunganEdit"
