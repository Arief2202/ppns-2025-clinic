...
@section('body')
                ...
                <div class="card-text me-3">
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-2">
                                ...
                                <input type="datetime-local" class="form-control" id="tanggal_kejadian"
                                    value="{{ $data->tanggal_kejadian }}" disabled>
                            </div>
                            <div class="mb-2">
                                <label for="lokasi_kejadian" class="form-label">Lokasi Kejadian</label>
                                <input type="text" class="form-control" id="lokasi_kejadian"
                                    value="{{ $data->lokasi_kejadian }}" disabled>
                            </div>
                            <div class="mb-2">
                                <label for="jenis_kecelakaan" class="form-label">Jenis Kecelakaan</label>
                                <input type="text" class="form-control" id="jenis_kecelakaan"
                                    value="{{ $data->jenis_kecelakaan }}" disabled>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="uraian_kejadian"
                                    value="{{ $data->uraian_kejadian }}" disabled>
                            </div>
                            <div class="mb-2">
                    ...
                    @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2 || Auth::user()->role_id == 3)
                        <div class="d-flex justify-content-end w-100 mb-2">
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal">Tambahkan
                                Korban</button>
                        </div>
                    @endif
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2 || Auth::user()->role_id == 3)
                                    <td>
                                        <form method="POST"
                                            action="/pelaporan-kecelakaan/laporan-kecelakaan-kerja/korban/delete">@csrf
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/pelaporan-kecelakaan/laporan-kecelakaan-kerja/korban/add" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <select class="selectpicker" data-live-search="true" id="pasien_id" name="pasien_id"
                                ...
                                @foreach ($pasiens as $pasien)
                                    <option value="{{ $pasien->id }}">[{{ $pasien->nip }}] {{ $pasien->nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" id="dampak_kejadian" name="dampak_kejadian"
                                required>
                        </div>
                        <div class="mb-2">
                            <label for="tindakan_pertolongan" class="form-label">Tindakan Pertolongan</label>
                            <input type="text" class="form-control" id="tindakan_pertolongan"
                                name="tindakan_pertolongan" required>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/pelaporan-kecelakaan/laporan-kecelakaan-kerja/edit" method="POST"
                    enctype="multipart/form-data">@csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="datetime-local" class="form-control" id="tanggal_kejadianEdit"
                                name="tanggal_kejadian" value="{{ $data->tanggal_kejadian }}">
                        </div>
                        <div class="mb-2">
                            <label for="lokasi_kejadianEdit" class="form-label">Lokasi Kejadian</label>
                            <input type="text" class="form-control" id="lokasi_kejadianEdit" name="lokasi_kejadian"
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" id="jenis_kecelakaanEdit" name="jenis_kecelakaan">
                                ...
                                <option value="Fatality" @if ($data->jenis_kecelakaan == 'Fatality') selected @endif>Fatality
                                </option>
                            </select>
                        </div>
                        <div class="mb-2">
                            <label for="uraian_kejadianEdit" class="form-label">Uraian Kejadian</label>
                            <input type="text" class="form-control" id="uraian_kejadianEdit" name="uraian_kejadian"
        ...
        $(document).ready(function() {
            ...
            $('#pasien_id').change(function() {
                if (this.options[this.selectedIndex].text == "Tambah Pasien Baru") {
                    document.getElementById('addNewPasienDiv').innerHTML = document.getElementById(
                        'templateAddNewUser').innerHTML;
                } else {
