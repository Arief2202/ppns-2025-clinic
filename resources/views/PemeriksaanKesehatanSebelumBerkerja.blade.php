...
@section('body')
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-sebelum-bekerja/edit"
...
@section('script')
    <script>
        ...
        function changeModal(id) {
            ...
            xhttp.open("GET", "/api/smk3/pemeriksaan-kesehatan-pekerja/pemeriksaan-kesehatan-sebelum-bekerja/get?id=" + id,
                true);
            xhttp.send();
        }
