                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary"
                                        href="/manajemen-farmasi/pemusnahan/detail?id={{ $data->id }}">Detail</button>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    ...
                    <form method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_pemusnahan" name="tanggal_pemusnahan"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="alasan_pemusnahan" class="form-label">Alasan Pemusnahan</label>
                                <input type="text" class="form-control" id="alasan_pemusnahan" name="alasan_pemusnahan"
                                    required>
                            </div>
                            <div class="mb-3">
                ...
                <div class="modal-content">
                    <form action="/manajemen-farmasi/pemusnahan/edit" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-2">
                                <select class="selectpicker" data-live-search="true" id="pengadaan_id"
                                    name="pengadaan_id">
                                    <option value="">Pilih Nomor Pengadaan</option>
                                    @foreach ($pengadaans as $pengadaan)
                                        <option value="{{ $pengadaan->id }}">{{ $pengadaan->nomor_pengadaan }}</option>
