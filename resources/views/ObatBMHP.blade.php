                      ...
                      <table id="myTable">
                        <thead class="thead">
                            <tr>
                                ...
                                @if(Auth::user()->role_id == 6)<th>Edit</th>@endif
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                @if(Auth::user()->role_id == 6)<td><button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editModal" onclick="changeModal({{$data->id}})">Edit</button></td>@endif
                                <td><a class="btn btn-primary" href="/manajemen-farmasi/list-pengadaan?id={{$data->id}}">List Pengadaan</a></td>
                                <td><a class="btn btn-primary" href="/manajemen-farmasi/list-pemusnahan?id={{$data->id}}">List Pemusnahan</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                      </table>
                    ...
                    <form action="/manajemen-farmasi/daftar-obat-bmhp/edit" method="POST">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tempat_penyimpananEdit" name="tempat_penyimpanan" required>
                            </div>
                        </div>
...
@section('script')
    <script>
        ...
        function del(){
            ...
            setTimeout(function() {
                if(document.getElementById('kategori').value == 'Obat') window.location.href = "/manajemen-farmasi/daftar-obat";
                if(document.getElementById('kategori').value == 'BMHP') window.location.href = "/manajemen-farmasi/daftar-bmhp";
            }, 200);
        }
    </script>
@endsection
