                      ...
                      <table id="myTable">
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary" onclick="window.open('{{$data->dokumentasi_klaim}}','_blank')">Lihat Dokumen</button></td>
                                <td>{{$data->status}}</td>
                    ...
                    <form method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="dokumentasi_klaim" name="dokumentasi_klaim" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alasan_penolakan" name="alasan_penolakan" required>
                            </div>
                        </div>
                    ...
                    <form action="/rekam-medis/klaim-pembiayaan/edit" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_pengajuanEdit" name="tanggal_pengajuan">
                            </div>
                            <div class="mb-3">
                                <label for="dokumentasi_klaimEdit" class="form-label">Dokumentasi Klaim</label>
                                <input type="file" class="form-control" id="dokumentasi_klaimEdit" name="dokumentasi_klaim">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="alasan_penolakanEdit" name="alasan_penolakan">
                            </div>
                        </div>
