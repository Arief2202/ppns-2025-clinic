...
@section('body')
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumen_analisis }}','_blank')">Lihat
                                        Dokumen</button></td>
                                <td>{{ $data->editor()->name }}</td>
                                @if (Auth::user()->role_id == 1)
                                    <td>
                                        @if (!$data->validator())
                                            <form method="POST" action="/rekam-medis/analisis-data-rekam-medis/validate">
                                                @csrf
                                        @endif
                ...
                <form method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_analisis" name="tanggal_analisis"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="dokumen_analisis" class="form-label">Dokumen Analisis</label>
                            <input type="file" class="form-control" id="dokumen_analisis" name="dokumen_analisis"
                                required>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/rekam-medis/analisis-data-rekam-medis/edit" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
