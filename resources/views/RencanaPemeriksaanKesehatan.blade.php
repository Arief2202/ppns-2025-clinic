...
@section('body')
                            ...
                            <tr>
                                ...
                                @if (Auth::user()->role_id == 3)
                                    <td>
                                        @if (!$data->validator())
                                            <form method="POST"
                                                action="/smk3/pemeriksaan-kesehatan-pekerja/rencana-pemeriksaan-kesehatan/validate">
                                                @csrf
                                        @endif
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/smk3/pemeriksaan-kesehatan-pekerja/rencana-pemeriksaan-kesehatan/edit" method="POST"
