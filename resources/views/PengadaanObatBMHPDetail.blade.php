        ...
        <div class="card-text me-3">
            ...
            @if (Auth::user()->role_id == 6)
                <div class="d-flex justify-content-end w-100 mb-2">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal">Tambahkan Obat /
                        BMHP</button>
                </div>
            @endif
            ...
            <div class="modal-content">
                <form action="/manajemen-farmasi/pengadaan/detail/add" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <select class="selectpicker" data-live-search="true" id="obat_bmhp_id" name="obat_bmhp_id"
                                required>
                                <option value="">Pilih Obat / BMHP</option>
                                <option value="" id="addNewItem">Tambah Obat / BMHP Baru</option>
                                @foreach ($items as $item)
                                    <option value="{{ $item->id }}">[{{ $item->kategori }}] {{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="modal-content">
                <form action="/manajemen-farmasi/pengadaan/edit" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="from_link"
                            value="/manajemen-farmasi/pengadaan/detail?id={{ $data->id }}">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_pengadaanEdit"
                                ...
                                value="{{ date('Y-m-d', strtotime($data->tanggal_pengadaan)) }}">
                        </div>
                        <div class="mb-3">
