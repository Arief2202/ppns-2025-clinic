...
@section('body')
    @include('layouts.cardOpen')
                      ...
                      <table id="myTable">
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                @if(Auth::user()->role_id == 4)
                                <td>
                                    @if(!$data->validator()) <form method="POST" action="/pelaporan-kecelakaan/laporan-analisis-kecelakaan-kerja/validate">@csrf @endif
                    ...
                    <form method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="tahun" min="1800" max="{{date('Y')}}" name="tahun" required>
                            </div>
                            <div class="mb-3">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/pelaporan-kecelakaan/laporan-analisis-kecelakaan-kerja/edit" method="POST" enctype="multipart/form-data">@csrf
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="tahunEdit" min="1800" max="{{date('Y')}}" name="tahun">
                            </div>
                            <div class="mb-3">
