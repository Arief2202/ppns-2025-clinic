...
@section('body')
    ...
    <div class="row mb-3">
        <label for="exampleInputEmail1" class="form-label">Link Survey</label>
        <div class="col-7 row">

            @if (Auth::user()->role_id == 5)
            <form action="/kesehatan-mental/data-kesehatan-mental/survey" method="POST" class="row"> @csrf
            @endif
                <div class="col-7">
                    <input type="text" class="form-control" value="{{$link}}" @if (Auth::user()->role_id != 5) disabled @else name="link_survey" @endif>
                </div>
                <div class="col-2">
                    <button class="btn btn-secondary w-100" onclick="window.open('{{ $link }}','_blank')">Go To Link</button>
                </div>

            @if (Auth::user()->role_id == 5)
                <div class="col-3">
                    <button type="submit" class="btn btn-primary w-100">Update Link</button>
                </div>
            </form>
            @endif
        </div>
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary"
                                        onclick="window.open('{{ $data->dokumen_kesehatan_mental }}','_blank')">Lihat
                                        Dokumen</button></td>
                                <td>{{ $data->editor()->name }}</td>
                                @if (Auth::user()->role_id == 1)
                                    <td>
                                        @if (!$data->validator())
                                            <form method="POST" action="/kesehatan-mental/data-kesehatan-mental/validate">
                                                @csrf
                                        @endif
                ...
                <form method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="dokumen_kesehatan_mental"
                                name="dokumen_kesehatan_mental" required>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/kesehatan-mental/data-kesehatan-mental/edit" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_pendataanEdit"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="dokumen_kesehatan_mentalEdit"
                                name="dokumen_kesehatan_mental">
                        </div>
                    </div>
