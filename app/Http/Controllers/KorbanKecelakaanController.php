...
use App\Http\Requests\StoreKorbanKecelakaanRequest;
use App\Http\Requests\UpdateKorbanKecelakaanRequest;
...
class KorbanKecelakaanController extends Controller
{
    /**
